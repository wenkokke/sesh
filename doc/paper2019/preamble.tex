...
\newcommand*{\linearEGV}{\ensuremath{\text{EGV}_{\!L}}\xspace}
\newcommand*{\affineEGV}{\ensuremath{\text{EGV}_{\!A}}\xspace}
\newcommand*{\affineAGV}{\ensuremath{\text{AGV}_{\!A}}\xspace}
...
\newcommand{\lta}[1]{\ensuremath{\st{{\downarrow}_{A}}#1}}
\newcommand{\atl}[1]{\ensuremath{\st{{\uparrow}_{A}}#1}}
\newcommand{\atm}[1]{\ensuremath{\st{{\downarrow}_{\mathbf{opt}}}#1}}
\newcommand{\mta}[1]{\ensuremath{\st{{\uparrow}_{\mathbf{opt}}}#1}}
