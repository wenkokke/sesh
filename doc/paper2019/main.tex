...
\begin{figure*}
  \begin{mdframed}
    ...
    \]
    {
      ...
      \end{prooftree}
      \begin{prooftree}
        \AXC{\tm{c} and \tm{d} are fresh}
        \RightLabel{E-Send}
        \UIC{$
          \rvRedTup{\rvHeapData{\rvHeap{H}}{a}{b}{\rvMemEmp}}{\rvPlug{F}{\rvSend{U}{a}}}
          \rvRedArr
          \rvRedTup{\rvHeapData{\rvHeapData{\rvHeap{H}}{a}{b}{\rvMemData{U}{c}}}{c}{d}{\rvMemEmp}}{\rvPlug{F}{d}}$}
      \end{prooftree}
      \begin{prooftree}
        \AXC{}
      ...
      \begin{prooftree}
        ...
        \UIC{$
          ...
          {\rvPlug{F}{\rvClose{a}}\st{,}\;\rvPlug{E'}{\rvClose{b}}}
          \rvRedArr
          \rvRedTup{\rvHeap{H}}{\rvPlug{F}{\rvSome{\rvUnit}}\st{,}\;\rvPlug{F'}{\rvSome{\rvUnit}}}$}
      \end{prooftree}
      \begin{prooftree}
        \AXC{$
          \tm{a}\notin\text{cn}{(\rvRedTup[\rvConf{C}]{\rvHeap{H}}{})}\;\text{or}\;
          \tm{b}\notin\text{cn}{(\rvRedTup[\rvConf{C}]{\rvHeap{H}}{})}$}
      ...
      \begin{prooftree}
        \AXC{$
          \tm{a}\notin\text{cn}{(\rvRedTup[\rvConf{C}]{\rvHeap{H}}{})}\;\text{and}\;
          \tm{b}\notin\text{cn}{(\rvRedTup[\rvConf{C}]{\rvHeap{H}}{})}$}
