...
\item
  ...
  \end{center}
\end{enumerate}
We can translate programs in \affineEGV to \affineAGV following Filinski~\cite{filinski1994}. We name this translation $\atm{}$. The definition of $\atm{}$ on terms is given in \cref{fig:affine-egv-to-agv}. We extend it to configurations by applying it to all terms in a configuration, \ie in threads and buffers.

TODO something is wrong with buffer typing here; do we want to store failing values in buffers?
